...
function SessionCard({
  ...
  return (
    <div
      className={`bg-white/10 backdrop-blur-lg rounded-2xl shadow-xl p-6 mb-6 border border-white/20 transition-all ${
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          ...
          <div className="flex items-center gap-2 bg-white/5 rounded-lg px-3 py-2">
            ...
            <select
              ...
              className="bg-transparent border-none text-white text-sm focus:ring-0 p-0"
              disabled={isArchived}
            >
              <option value={2} className="bg-emerald-900">
                2
          ...
          <div className="flex items-center gap-1 bg-white/5 rounded-lg px-3 py-2">
            ...
            <input
              ...
              placeholder="0"
              className="w-14 bg-transparent border-none text-white text-sm text-right focus:ring-0 p-0"
              disabled={isArchived}
            />
          </div>
          ...
          {onDelete ? (
            <button
              ...
              className="text-sm px-3 py-2 rounded-lg bg-red-500/20 text-red-400 hover:bg-red-500/30 transition-all cursor-pointer"
            >
              🗑️ Delete
            </button>
          ) : (
